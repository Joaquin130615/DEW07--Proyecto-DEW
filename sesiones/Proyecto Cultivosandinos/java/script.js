...
// Modal de registro: abrir, cerrar y manejo de envío
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(form){
        form.addEventListener('submit', function(e){
            e.preventDefault();
            // Placeholder: aquí se puede enviar por fetch a la API
            alert('Registro recibido. Implementar envío real si se desea.');
            form.reset();
            closeModal();
        });
    }
